...
export default function _showElement(targetElement) {
  ...
  if (oldHelperLayer !== null) {
    ...
    self._lastShowElementTimer = window.setTimeout(() => {
      ...
      placeTooltip.call(self, targetElement.element, oldtooltipContainer, oldArrowLayer, oldHelperNumberLayer);
    ...
    //set proper position
    placeTooltip.call(self, targetElement.element, tooltipLayer, arrowLayer, helperNumberLayer);
