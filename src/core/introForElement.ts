...
export default function introForElement(
  ...
  if (this._options.steps) {
    ...
    forEach(this._options.steps, (step: HTMLElement) => {
      ...
      if (
        ...
        let floatingElementQuery: HTMLElement | null = document.querySelector(
    ...
    forEach(allIntroSteps, (currentElement: HTMLElement) => {
      // PR #80
