(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es7.array.includes'), require('core-js/modules/es6.string.includes'), require('core-js/modules/es6.regexp.split'), require('core-js/modules/es6.array.index-of'), require('core-js/modules/es6.regexp.replace'), require('core-js/modules/es6.function.bind'), require('core-js/modules/es6.regexp.match'), require('core-js/modules/es6.array.sort'), require('core-js/modules/es6.regexp.to-string'), require('core-js/modules/es6.date.to-string'), require('core-js/modules/es6.object.to-string')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es7.array.includes', 'core-js/modules/es6.string.includes', 'core-js/modules/es6.regexp.split', 'core-js/modules/es6.array.index-of', 'core-js/modules/es6.regexp.replace', 'core-js/modules/es6.function.bind', 'core-js/modules/es6.regexp.match', 'core-js/modules/es6.array.sort', 'core-js/modules/es6.regexp.to-string', 'core-js/modules/es6.date.to-string', 'core-js/modules/es6.object.to-string'], factory) :
  ...
  function _onKeyDown(e) {
    ...
    if ((code === 'Escape' || code === 27) && this._options.exitOnEsc === true) {
      ...
      _exitIntro$1.call(this, this._targetElement);
  ...
  function _nextStep() {
    ...
    if (typeof this._currentStepNumber !== 'undefined') {
      forEach(this._introItems, function (_ref, i) {
        ...
        if (step === _this2._currentStepNumber) {
          _this2._currentStep = i - 1;
          _this2._currentStepNumber = undefined;
        }
      });
    }
  ...
  function _exitIntro$1(targetElement, force) {
  ...
  function _determineAutoAlignment(offsetLeft, tooltipWidth, _ref2, desiredAlignment) {
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer !== null) {
      ...
      forEach(this._introItems, function (_ref3, i) {
        var step = _ref3.step;
      ...
      skipTooltipButton.onclick = function () {
        ...
        _exitIntro$1.call(self, self._targetElement);
      };
  ...
  introJs.fn = IntroJs.prototype = {
    ...
    exit: function exit(force) {
      _exitIntro$1.call(this, this._targetElement, force);
