...
b=e-b,0>c?window.scrollBy(0,c-30):window.scrollBy(0,b+100))}function v(a){var b=document.createElement("div"),d="",c=this;b.className="introjs-overlay";if("body"===a.tagName.toLowerCase())d+="top: 0;bottom: 0; left: 0;right: 0;position: fixed;",b.setAttribute("style",d);else{var e=m(a);e&&(d=this._options.fullScreen?d+("width:100%!important;height:"+document.body.clientHeight+"px!important;top:0!important;left:0!important;position:absolute!important;"):d+("width: "+e.width+"px; height:"+e.height+
"px; top:"+e.top+"px;left: "+e.left+"px;"),b.setAttribute("style",d))}a.appendChild(b);b.onclick=function(){k.call(c,a)};setTimeout(function(){d+="opacity: .5;";b.setAttribute("style",d)},10);return!0}function m(a){var b={};b.width=a.offsetWidth;b.height=a.offsetHeight;for(var d=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)d+=a.offsetLeft,c+=a.offsetTop,a=a.offsetParent;b.top=c;b.left=d;return b}var p=function(a){if("object"===typeof a)return new f(a);if("string"===typeof a){if(a=document.querySelector(a))return new f(a);
throw Error("There is no element with given selector.");}return new f(document.body)};p.version="0.3.0";p.fn=f.prototype={clone:function(){return new f(this)},setOption:function(a,b){this._options[a]=b;return this},setOptions:function(a){var b=this._options,d={},c;for(c in b)d[c]=b[c];for(c in a)d[c]=a[c];this._options=d;return this},start:function(){var a=this._targetElement,b=a.querySelectorAll(void 0==this._options.group?"*[data-intro]":"*[data-intro]"+this._options.group),d=[],c=this;if(!(1>b.length)){for(var e=
0,f=b.length;e<f;e++){var g=b[e];d.push({element:g,intro:g.getAttribute("data-intro"),step:parseInt(g.getAttribute("data-step"),10),position:g.getAttribute("data-position")||this._options.tooltipPosition})}d.sort(function(a,b){return a.step-b.step});c._introItems=d;v.call(c,a)&&(l.call(c),a.querySelector(".introjs-skipbutton"),a.querySelector(".introjs-nextbutton"),c._onKeyDown=function(b){27===b.keyCode?k.call(c,a):37===b.keyCode?r.call(c):(39===b.keyCode||13===b.keyCode)&&l.call(c)},window.addEventListener?
window.addEventListener("keydown",c._onKeyDown,!0):document.attachEvent&&document.attachEvent("onkeydown",c._onKeyDown))}return this},goToStep:function(a){this._currentStep=a-2;"undefined"!==typeof this._introItems&&l.call(this);return this},exit:function(){k.call(this,this._targetElement)},onchange:function(a){if("function"===typeof a)this._introChangeCallback=a;else throw Error("Provided callback for onchange was not a function.");return this},oncomplete:function(a){if("function"===typeof a)this._introCompleteCallback=
a;else throw Error("Provided callback for oncomplete was not a function.");return this},onexit:function(a){if("function"===typeof a)this._introExitCallback=a;else throw Error("Provided callback for onexit was not a function.");return this}};return g.introJs=p});
